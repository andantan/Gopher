...
func (x *GetOrderReponse) GetOrders() []*Order {
	if x != nil {
		return x.Orders
	}
	return nil
...
const file_orders_proto_rawDesc = "" +
	...
	"customerID\x18\x01 \x01(\x05R\n" +
	"customerID\"1\n" +
	"\x0fGetOrderReponse\x12\x1e\n" +
	"\x06orders\x18\x01 \x03(\v2\x06.OrderR\x06orders2J\n" +
	"\fOrderService\x12:\n" +
	"\vCreateOrder\x12\x13.CreateOrderRequest\x1a\x14.CreateOrderResponse\"\x00B\"Z opet/gRPC/services/common/ordersb\x06proto3"
...
var file_orders_proto_goTypes = []any{
	...
	(*GetOrderReponse)(nil),     // 4: GetOrderReponse
}
var file_orders_proto_depIdxs = []int32{
	0, // 0: GetOrderReponse.orders:type_name -> Order
